...
- **Modulateur par couche** : un LFO qui fait respirer un réglage tout seul — niveau, largeur, vitesse, netteté, profondeur… Il ne modifie jamais le réglage affiché, il se superpose : le couper rend la main immédiatement.
